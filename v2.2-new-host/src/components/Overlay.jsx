...
export default function Overlay() {
  ...
  // 'connection' | 'settings' | 'library'
  const [activeView, setActiveView] = createSignal('connection');
  ...
  const sideOpen = () => activeView() !== 'connection';

  const toggleView = (view) => {
    setActiveView(prev => prev === view ? 'connection' : view);
  };

  const goBack = () => setActiveView('connection');
