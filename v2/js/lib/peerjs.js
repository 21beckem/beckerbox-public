( () => {
    ...
    class s {
        unpack() {
            ...
            if ((224 ^ t) < 32)
                return (224 ^ t) - 32;
            if ((e = 160 ^ t) <= 15)
                return this.unpack_raw(e);
            if ((e = 176 ^ t) <= 15)
                return this.unpack_string(e);
            if ((e = 144 ^ t) <= 15)
                return this.unpack_array(e);
            if ((e = 128 ^ t) <= 15)
                return this.unpack_map(e);
            switch (t) {
            case 192:
                return null;
            case 193:
            ...
            case 216:
                return e = this.unpack_uint16(),
                this.unpack_string(e);
            case 217:
                return e = this.unpack_uint32(),
                this.unpack_string(e);
            case 218:
                return e = this.unpack_uint16(),
                this.unpack_raw(e);
        ...
        unpack_uint64() {
            let e = this.read(8)
              , t = ((((((256 * e[0] + e[1]) * 256 + e[2]) * 256 + e[3]) * 256 + e[4]) * 256 + e[5]) * 256 + e[6]) * 256 + e[7];
            return this.index += 8,
            t
        }
        unpack_int8() {
        ...
        unpack_raw(e) {
            if (this.length < this.index + e)
                throw Error(`BinaryPackFailure: index is out of range ${this.index} ${e} ${this.length}`);
        ...
        unpack_string(e) {
            ...
            let r = this.read(e)
              ...
              , o = "";
            for (; i < e; )
                (t = r[i]) < 160 ? (// One-byte sequence: bits 0xxxxxxx
                n = t,
                i++) : (192 ^ t) < 32 ? (// Two-byte sequence: bits 110xxxxx 10xxxxxx
                n = (31 & t) << 6 | 63 & r[i + 1],
                i += 2) : (224 ^ t) < 16 ? (// Three-byte sequence: bits 1110xxxx 10xxxxxx 10xxxxxx
                n = (15 & t) << 12 | (63 & r[i + 1]) << 6 | 63 & r[i + 2],
                i += 3) : (// Four-byte sequence: bits 11110xxx 10xxxxxx 10xxxxxx 10xxxxxx
                n = (7 & t) << 18 | (63 & r[i + 1]) << 12 | (63 & r[i + 2]) << 6 | 63 & r[i + 3],
                i += 4),
    ...
    class a {
        ...
        pack_double(e) {
            ...
            let n = Math.floor(Math.log(e) / Math.LN2)
              , r = e / 2 ** n - 1
              , i = Math.floor(4503599627370496 * r)
              , o = t << 31 | n + 1023 << 20 | i / 4294967296 & 1048575;
            this._bufferBuilder.append(203),
            this.pack_int32(o),
            this.pack_int32(i % 4294967296)
        }
        pack_object(e) {
            let t = Object.keys(e)
              , n = t.length;
            if (n <= 15)
                ...
                throw Error("Invalid length");
            for (let t in e)
                e.hasOwnProperty(t) && (this.pack(t),
                this.pack(e[t]))
        }
        pack_uint8(e) {
    ...
    function u(e) {
        return "boolean" != typeof e ? Error("Argument type: " + typeof e + ". Please use a boolean.") : (l = !e,
 ...
 */
          ...
          , i = function(e, i) {
            ...
            if (e && "object" == typeof e.video) {
                ...
                if (o && ("user" === o.exact || "environment" === o.exact || "user" === o.ideal || "environment" === o.ideal) && !(n.mediaDevices.getSupportedConstraints && n.mediaDevices.getSupportedConstraints().facingMode && !s)) {
                    ...
                    "environment" === o.exact || "environment" === o.ideal ? t = ["back", "rear"] : ("user" === o.exact || "user" === o.ideal) && (t = ["front"]),
                    t)
                        return n.mediaDevices.enumerateDevices().then(n => {
                            ...
                            return !s && n.length && t.includes("back") && (s = n[n.length - 1]),
                            s && (e.video.deviceId = o.exact ? {
                                exact: s.deviceId
                            } : {
                                ideal: s.deviceId
                            }),
    ...
    function F(e) {
        if ("object" != typeof e || !e.RTCPeerConnection || "ontrack"in e.RTCPeerConnection.prototype)
            ...
            d(e, "track", e => (e.transceiver || Object.defineProperty(e, "transceiver", {
                value: {
                    receiver: e.receiver
                }
            }),
    ...
    function N(e) {
        ...
        if (!("getStats"in e.RTCRtpSender.prototype)) {
            ...
            e.RTCRtpSender.prototype.getStats = function() {
                let e = this;
                return this._pc.getStats().then(t => /* Note: this will include stats of all senders that
        ...
        if (!("getStats"in e.RTCRtpReceiver.prototype)) {
            ...
            d(e, "track", e => (e.receiver._pc = e.srcElement,
            e)),
    ...
    function $(e) {
        ...
        e.RTCPeerConnection.prototype.addStream = function(e) {
            this._shimmedLocalStreams = this._shimmedLocalStreams || {},
            e.getTracks().forEach(e => {
                let t = this.getSenders().find(t => t.track === e);
                if (t)
    ...
    function J(e, t) {
        ...
        e.RTCPeerConnection.prototype.addTrack = function(t, n) {
            ...
            let i = this.getSenders().find(e => e.track === t);
            if (i)
                throw new DOMException("Track already exists.","InvalidAccessError");
            this._streams = this._streams || {},
            this._reverseStreams = this._reverseStreams || {};
            let o = this._streams[n.id];
            if (o)
        ...
        e.RTCPeerConnection.prototype.removeTrack = function(e) {
            ...
            Object.keys(this._streams).forEach(n => {
                let r = this._streams[n].getTracks().find(t => e.track === t);
                r && (t = this._streams[n])
            }
            ),
            t && (1 === t.getTracks().length ? // takes care of any shimmed _senders.
            this.removeStream(this._reverseStreams[t.id]) : t.removeTrack(e.track),
            this.dispatchEvent(new Event("negotiationneeded")))
        }
    }
    function V(e, t) {
    ...
    function et(e) {
        ...
        t && (e.RTCPeerConnection.prototype.addTransceiver = function() {
            ...
            if (n) {
                ...
                let {sender: t} = r
                  , n = t.getParameters();
                "encodings"in n && // Avoid being fooled by patched getParameters() below.
                (1 !== n.encodings.length || 0 !== Object.keys(n.encodings[0]).length) || (n.encodings = e,
                t.sendEncodings = e,
 ...
 */
    ...
    function e_(e) {
        ...
        e.RTCIceCandidate = function(e) {
            ...
            e.candidate && e.candidate.length) {
                ...
                let r = new n(e)
                  , i = /*@__PURE__*/
                t(eg).parseCandidate(e.candidate);
                for (let e in i)
                    e in r || Object.defineProperty(r, e, {
                        value: i[e]
                    });
                return (// Override serializer to not serialize the extra attributes.
                r.toJSON = function() {
                    return {
        ...
        d(e, "icecandidate", t => (t.candidate && Object.defineProperty(t, "candidate", {
    ...
    function eC(e) {
        ...
        d(e, "icecandidate", e => {
            if (e.candidate) {
                let n = /*@__PURE__*/
                t(eg).parseCandidate(e.candidate.candidate);
                "relay" === n.type && // to relayProtocol.
    ...
    function ev(e, n) {
        ...
        let r = function(e) {
          ...
          , o = function(e) {
            ...
            let t = 65536;
            return "firefox" === n.browser && (// fragmentation.
            t = n.version < 57 ? -1 === e ? 16384 : 2147483637 : n.version < 60 ? 57 === n.version ? 65535 : 65536 : 2147483637),
            t
        }
          , s = function(e, r) {
            ...
            let o = /*@__PURE__*/
            t(eg).matchPrefix(e.sdp, "a=max-message-size:");
            return o.length > 0 ? i = parseInt(o[0].substring(19), 10) : "firefox" === n.browser && -1 !== r && // both local and remote are Firefox, the remote peer can receive
            // ~2 GiB.
            (i = 2147483637),
            i
        }
    ...
    function eb(e) {
        ...
        ,
        d(e, "datachannel", e => (t(e.channel, e.target),
        e))
    }
    function ek(e) {
    ...
    function eR(e, t) {
        ...
        n && 0 !== n.length && (e.RTCPeerConnection.prototype.setLocalDescription = function() {
            ...
            if ("object" != typeof e || e.type && e.sdp)
                return n.apply(this, arguments);
            if (!// The remaining steps should technically happen when SLD comes off the
            ...
            let t = "offer" === e.type ? this.createOffer : this.createAnswer;
    ...
    ey.splitSections = function(e) {
        let t = e.split("\nm=");
        return t.map( (e, t) => (t > 0 ? "m=" + e : e).trim() + "\r\n")
    }
    ,
    ...
    ey.getDtlsParameters = function(e, t) {
        let n = ey.matchPrefix(e + t, "a=fingerprint:");
        // Note: a=setup line is ignored since we use the 'auto' role in Edge.
        return {
            role: "auto",
            fingerprints: n.map(ey.parseFingerprint)
        }
    }
    ,
    ...
    ey.getCryptoParameters = function(e, t) {
        let n = ey.matchPrefix(e + t, "a=crypto:");
        return n.map(ey.parseCryptoLine)
    }
    ,
    ...
    ey.parseRtpParameters = function(e) {
        ...
        for (let n = 3; n < r.length; n++) {
            ...
            if (o) {
                ...
                n.rtcpFeedback = ey.matchPrefix(e, "a=rtcp-fb:" + i + " ").map(ey.parseRtcpFb),
                t.codecs.push(n),
                n.name.toUpperCase()) {
                case "RED":
                case "ULPFEC":
        ...
        let i = ey.matchPrefix(e, "a=rtcp-fb:* ").map(ey.parseRtcpFb);
        // FIXME: parse rtcp.
        return t.codecs.forEach(e => {
            i.forEach(t => {
                let n = e.rtcpFeedback.find(e => e.type === t.type && e.parameter === t.parameter);
                n || e.rtcpFeedback.push(t)
            }
            )
        }
        ),
    ...
    ey.parseRtpEncodingParameters = function(e) {
        ...
        let n = []
          ...
          , s = ey.matchPrefix(e, "a=ssrc:").map(e => ey.parseSsrcMedia(e)).filter(e => "cname" === e.attribute)
          , a = s.length > 0 && s[0].ssrc
          , c = ey.matchPrefix(e, "a=ssrc-group:FID").map(e => {
            let t = e.substring(17).split(" ");
            return t.map(e => parseInt(e, 10))
        }
        );
        ...
        return l.length && (l = 0 === l[0].indexOf("b=TIAS:") ? parseInt(l[0].substring(7), 10) : 0 === l[0].indexOf("b=AS:") ? 950 * parseInt(l[0].substring(5), 10) - 16e3 : void 0,
        n.forEach(e => {
            e.maxBitrate = l
        }
        )),
    ...
    ey.parseRtcpParameters = function(e) {
        let t = {}
          , n = ey.matchPrefix(e, "a=ssrc:").map(e => ey.parseSsrcMedia(e)).filter(e => "cname" === e.attribute)[0];
        n && (t.cname = n.value,
        t.ssrc = n.ssrc);
    ...
    let ew = function({window: e}={}, t={
        ...
        let n = function(e) {
            ...
            t.version = p(n.userAgent, /Firefox\/(\d+)\./, 1)) : n.webkitGetUserMedia || !1 === e.isSecureContext && e.webkitRTCPeerConnection ? (// Chrome, Chromium, Webview, Opera.
            // Version matches Chrome/WebRTC version.
            // Chrome 74 removed webkitGetUserMedia on http as well so we need the
            // more complicated fallback to webkitRTCPeerConnection.
            t.browser = "chrome",
            t.version = p(n.userAgent, /Chrom(e|ium)\/(\d+)\./, 2)) : e.RTCPeerConnection && n.userAgent.match(/AppleWebKit\/(\d+)\./) ? (t.browser = "safari",
      ...
      , eE = new class {
        ...
        isBrowserSupported() {
            let e = this.getBrowser()
              , t = this.getVersion()
              , n = this.supportedBrowsers.includes(e);
            return !!n && ("chrome" === e ? t >= this.minChromeVersion : "firefox" === e ? t >= this.minFirefoxVersion : "safari" === e && !this.isIOS && t >= this.minSafariVersion)
        }
        getBrowser() {
    ...
    var eO = new class {
        ...
        log(...e) {
            this._logLevel >= w.All && this._print(w.All, ...e)
        }
        warn(...e) {
            this._logLevel >= w.Warnings && this._print(w.Warnings, ...e)
        }
        error(...e) {
            this._logLevel >= w.Errors && this._print(w.Errors, ...e)
        }
        setLogFunction(e) {
            this._print = e
        }
        _print(e, ...t) {
            ...
            e >= w.All ? console.log(...n) : e >= w.Warnings ? console.warn("WARNING", ...n) : e >= w.Errors && console.error("ERROR", ...n)
        }
        constructor() {
            this._logLevel = w.Disabled
        }
    }
      , ej = {}
 ...
 */
    ...
    Object.create && (eB.prototype = Object.create(null),
    new eB().__proto__ || (eA = !1)),
    /**
 ...
 */
    eN.prototype.listeners = function(e) {
        ...
        if (n.fn)
            return [n.fn];
        for (var r = 0, i = n.length, o = Array(i); r < i; r++)
            o[r] = n[r].fn;
        return o
    }
    ,
 ...
 */
    eN.prototype.removeListener = function(e, t, n, r) {
        ...
        if (o.fn)
            o.fn !== t || r && !o.once || n && o.context !== n || eU(this, i);
        else {
            for (var s = 0, a = [], c = o.length; s < c; s++)
                (o[s].fn !== t || r && !o[s].once || n && o[s].context !== n) && a.push(o[s]);
 ...
 */
    eN.prototype.removeAllListeners = function(e) {
        var t;
        return e ? (t = eA ? eA + e : e,
        this._events[t] && eU(this, t)) : (this._events = new eB,
        this._eventsCount = 0),
        this
    }
    ,
    ...
    class eJ extends ej.EventEmitter {
        start(e, t) {
            ...
            this._socket.onclose = e => {
                this._disconnected || (eO.log("Socket closed.", e),
                this._cleanup(),
        ...
        _sendQueuedMessages() {
            ...
            for (let t of (this._messagesQueue = [],
            e))
                this.send(t)
        }
    ...
    class eV {
        ...
        startConnection(e) {
            ...
            this.connection.type === P.Media && e._stream && this._addTracksToConnection(e._stream, t),
            e.originator) {
        ...
        _setupListeners(e) {
            ...
            e.onicecandidate = e => {
                e.candidate && e.candidate.candidate && (eO.log(`Received ICE candidates for ${t}:`, e.candidate),
                i.socket.send({
                    type: O.Candidate,
                    payload: {
            ...
            e.oniceconnectionstatechange = () => {
                ...
                case "failed":
                    eO.log("iceConnectionState is failed, closing connections to " + t),
                    this.connection.emitError(D.NegotiationFailed, "Negotiation of connection to " + t + " failed."),
                    this.connection.close();
                    break;
                case "closed":
                    eO.log("iceConnectionState is closed, closing connections to " + t),
                    this.connection.emitError(D.ConnectionClosed, "Connection to " + t + " closed."),
                    this.connection.close();
                    break;
                case "disconnected":
        ...
        async _makeOffer() {
            ...
            try {
                ...
                try {
                    ...
                    "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" != e && (t.emitError(E.WebRTC, e),
                    eO.log("Failed to setLocalDescription, ", e))
                }
            } catch (e) {
                t.emitError(E.WebRTC, e),
                eO.log("Failed to createOffer, ", e)
            }
        }
        async _makeAnswer() {
            let e = this.connection.peerConnection
            ...
            try {
                ...
                t.emitError(E.WebRTC, e),
                eO.log("Failed to create answer, ", e)
            }
        }
        /** Handle an SDP. */
        async handleSDP(e, t) {
            ...
            try {
                ...
                r.emitError(E.WebRTC, e),
                eO.log("Failed to setRemoteDescription, ", e)
            }
        }
        /** Handle a candidate. */
        ...
        _addTracksToConnection(e, t) {
            if (eO.log(`add tracks from stream ${e.id} to peer connection`),
            !t.addTrack)
                return eO.error("Your browser does't support RTCPeerConnection#addTrack. Ignored.");
	 ...
	 */
        handleMessage(e) {
            ...
            switch (e.type) {
            case O.Answer:
                this._negotiator.handleSDP(t, n.sdp),
                this._open = !0;
                break;
            case O.Candidate:
	 ...
	 */
        ...
        constructor(e, t, n) {
            ...
            this.connectionId = this.options.connectionId || eY.ID_PREFIX + eM.randomToken(),
    ...
    class eK {
        _buildRequest(e) {
            ...
            return (// TODO: Why timestamp, why random?
        ...
        async retrieveId() {
            try {
                ...
                let e = "";
                throw "/" === this._options.path && this._options.host !== eM.CLOUD_HOST && (e = " If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),
        ...
        async listAllPeers() {
            try {
                ...
                if (200 !== e.status) {
                    if (401 === e.status) {
                        let e = "";
                        throw e = this._options.host === eM.CLOUD_HOST ? "It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key." : "You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.",
                        Error("It doesn't look like you have permission to list peers IDs. " + e)
                    }
                    throw Error(`Error. Status:${e.status}`)
                }
                return e.json()
            } catch (e) {
                throw eO.error("Error retrieving list peers", e),
    ...
    eX.ID_PREFIX = "dc_",
    eX.MAX_BUFFERED_AMOUNT = 8388608;
    class eq extends eX {
        get bufferSize() {
        ...
        _trySend(e) {
            ...
            try {
                ...
                return eO.error(`DC#:${this.connectionId} Error when sending:`, e),
                this._buffering = !0,
                this.close(),
                !1
            }
        ...
        _tryBuffer() {
            ...
            this._trySend(e) && (this._buffer.shift(),
            this._bufferSize = this._buffer.length,
            this._tryBuffer())
        }
        close(e) {
    ...
    class eQ extends eq {
        ...
        _handleChunk(e) {
            ...
            if (n.data[e.n] = new Uint8Array(e.data),
            n.count++,
        ...
        _sendChunks(e) {
            ...
            for (let e of (eO.log(`DC#${this.connectionId} Try to send ${t.length} chunks...`),
            t))
                this.send(e, !0)
        }
        constructor(e, t, r) {
	 ...
	 */
        get connections() {
            ...
            for (let[t,n] of this._connections)
                e[t] = n;
            return e
        }
        /**
	 ...
	 */
        ...
        _createServerConnection() {
            ...
            e.on(M.Disconnected, () => {
                this.disconnected || (this.emitError(E.Network, "Lost connection to server."),
                this.disconnect())
            }
            ),
            e.on(M.Close, () => {
        ...
        _initialize(e) {
            this._id = e,
            this.socket.start(e, this._options.token)
        }
	 ...
	 */
        ...
        _getMessages(e) {
            ...
            return t ? (this._lostMessages.delete(e),
            t) : []
        }
        /**
	 ...
	 */
        connect(e, t={}) {
            ...
            this.disconnected) {
                eO.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available."),
                this.emitError(E.Disconnected, "Cannot connect to new Peer after disconnecting from server.");
                return
            }
            let n = new this._serializers[t.serialization](e,this,t);
            return this._addConnection(e, n),
            n
        }
        /**
	 ...
	 */
        call(e, t, n={}) {
            if (this.disconnected) {
                eO.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect."),
                this.emitError(E.Disconnected, "Cannot connect to new Peer after disconnecting from server.");
                return
            }
            if (!t) {
            ...
            return this._addConnection(e, r),
            r
        }
	 ...
	 */
        destroy() {
            this.destroyed || (eO.log(`Destroy peer with ID:${this.id}`),
            this.disconnect(),
            // this._cleanup(),
            this._destroyed = !0,
            this.emit("close"))
	 ...
	 */
        reconnect() {
            if (this.disconnected && !this.destroyed)
                eO.log(`Attempting reconnection to server with ID ${this._lastServerId}`),
                this._disconnected = !1,
                ...
                eO.error("In a hurry? We're still trying to make the initial connection!")
        }
        /**
	 ...
	 */
        ...
        constructor(e, t) {
            ...
            void 0 === this._options.secure && this._options.host !== eM.CLOUD_HOST ? this._options.secure = eM.isSecure() : this._options.host == eM.CLOUD_HOST && (this._options.secure = !0),
            this._options.logFunction && eO.setLogFunction(this._options.logFunction),
